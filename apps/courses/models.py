...
class CourseInfo(models.Model):
    ...
    category = models.CharField(choices=(('qd','前端开发'),('hd','后端开发'),('qt','其他')),verbose_name="课程类别",max_length=5)
    ...
    orginfo = models.ForeignKey(OrgInfo,verbose_name="所属机构",on_delete="CASCADE")
    teacherinfo = models.ForeignKey(TeacherInfo,verbose_name="所属讲师",on_delete="CASCADE")
...
class LessonInfo(models.Model):
    ...
    courseinfo = models.ForeignKey(CourseInfo,verbose_name="所属课程",on_delete="CASCADE")
    add_time = models.DateTimeField(default=datetime.now, verbose_name="添加时间")
...
class VideoInfo(models.Model):
    ...
    lessoninfo = models.ForeignKey(LessonInfo,verbose_name="所属章节",on_delete="CASCADE")
    add_time = models.DateTimeField(default=datetime.now, verbose_name="添加时间")
