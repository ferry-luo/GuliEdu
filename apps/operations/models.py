...
class UserLove(models.Model):
    love_man = models.ForeignKey(UserProfile,verbose_name="收藏用户",on_delete="CASCADE")
...
class UserCourse(models.Model):
    study_man = models.ForeignKey(UserProfile, verbose_name="学习用户",on_delete="CASCADE")
    study_course = models.ForeignKey(CourseInfo,verbose_name="学习课程",on_delete="CASCADE")
...
class UserComment(models.Model):
    comment_man = models.ForeignKey(UserProfile, verbose_name="评论用户",on_delete="CASCADE")
    comment_course = models.ForeignKey(CourseInfo, verbose_name="评论课程",on_delete="CASCADE")
