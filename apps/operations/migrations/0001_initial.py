# Generated by Django 2.0 on 2020-07-11 23:58
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('comment_course', models.ForeignKey(on_delete='CASCADE', to='courses.CourseInfo', verbose_name='评论课程')),
                ('comment_man', models.ForeignKey(on_delete='CASCADE', to=settings.AUTH_USER_MODEL, verbose_name='评论用户')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('study_course', models.ForeignKey(on_delete='CASCADE', to='courses.CourseInfo', verbose_name='学习课程')),
                ('study_man', models.ForeignKey(on_delete='CASCADE', to=settings.AUTH_USER_MODEL, verbose_name='学习用户')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('love_man', models.ForeignKey(on_delete='CASCADE', to=settings.AUTH_USER_MODEL, verbose_name='收藏用户')),
            ],
            options={
                'verbose_name': '收藏信息',
