...
class OrgInfo(models.Model):
    ...
    detail = UEditorField(verbose_name='机构详情',
                          ...
                          imagePath='ueditor/images/',  # 图像被上传在服务器的路径
                          filePath='ueditor/files/',  # 如Excel等文件被上传在服务器的路径
                          upload_settings={'imageMaxSizing': 1024000},  # 图片最大只能
                          default='')  # 默认：不上传则是空串
    ...
    category = models.CharField(choices=(('pxjg', '培训机构'), ('gx', '高校'), ('gr', '个人')), max_length=10,
                                verbose_name="机构类别")
    cityinfo = models.ForeignKey(CityInfo, verbose_name="所在城市", on_delete="CASCADE")
    add_time = models.DateTimeField(default=datetime.now, verbose_name="添加时间")
...
class TeacherInfo(models.Model):
    ...
    work_company = models.ForeignKey(OrgInfo, verbose_name="所属机构", on_delete="CASCADE")
