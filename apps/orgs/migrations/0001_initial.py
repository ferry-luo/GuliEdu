    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('add_time', models.DateTimeField(default=datetime.datetime.now, verbose_name='添加时间')),
                ('cityinfo', models.ForeignKey(on_delete='CASCADE', to='orgs.CityInfo', verbose_name='所在城市')),
            ],
            options={
                'verbose_name': '机构信息',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('click_num', models.IntegerField(default=0, verbose_name='访问量')),
                ('add_time', models.DateTimeField(default=datetime.datetime.now, verbose_name='添加时间')),
                ('work_company', models.ForeignKey(on_delete='CASCADE', to='orgs.OrgInfo', verbose_name='所属机构')),
            ],
            options={
                'verbose_name': '讲师信息',
